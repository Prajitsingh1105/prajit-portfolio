      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center w-full">
        <div className="order-2 md:order-1 flex flex-col gap-6 items-start">
          ...
          <div className="flex flex-wrap gap-4 mt-8">
            <a href="#portfolio" className="px-8 py-3 bg-primary text-white rounded-md font-bold hover:scale-105 transition-transform duration-200">
              View Resume
            </a>
            <a href="#contact" className="px-8 py-3 border border-primary text-primary rounded-md font-bold hover:bg-primary/10 transition-colors duration-200">
              Contact Me
            </a>
          </div>
        </div>
